...
class CausalSelfAttention(nn.Module):
    ...
    def forward(self, x):
        B, T, C = x.size() # batch size, sequence size, embedding dimensions (n_embd)
...
class GPTConfig:
    ...
    vocab_size: int = 50257 # number of length: 50,000 BPE merges + 256 bytes tokens + 1 <|endoftext|> token
